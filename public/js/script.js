        ...
        for (let i = 1; i < 50; i++) {
            ...
            if (punctuationMode) {
                if (previousWord.charAt(previousWord.length - 1) == ".") {
                    ...
                    (Math.random() < 0.1 && previousWord.charAt(previousWord.length - 1) != ".") || i == wordsConfig - 1
                ) {
                    randomWord += ".";
                    ...
                    Math.random() < 0.01 && previousWord.charAt(previousWord.length - 1) != "," && previousWord.charAt(previousWord.length - 1) != "." && previousWord != "-"
                ) {
                    randomWord = "-";
                } else if (
                    Math.random() < 0.2 && previousWord.charAt(previousWord.length - 1) != ","
                ) {
                    randomWord += ",";
                }
            }
